...
// Report error into Runtime object just a wrapper for string formatting
inline void ReportError( Runtime* rt , const char* fmt , ... ) {
  //TODO:: This is function needs to be modified to do a stack unwind
  va_list arg;
  va_start(arg,fmt);
  FormatV(rt->error,fmt,arg);
}
...
#define _DO(OP) output->SetBoolean(*left.GetString() OP *right.GetString()); break
    ...
    switch(CurrentBytecode(sandbox)) {
...
#define _DO(OP) return left.IsExtension() ? \
    ...
    switch(CurrentBytecode(sandbox)) {
      ...
      case BC_EQRV: case BC_EQVR: case BC_EQVV: _DO(Eq);
      default: _DO(Ne);
    }
#undef _DO // _DO
  } else if(left.IsReal() && right.IsReal()) {
...
bool  InterpreterPropGetSSO( Runtime* sandbox , Value obj , SSO* key ,
                                                            Value* output ) {
  (void)sandbox;
  (void)obj;
  (void)key;
...
void InterpreterPropGetSSONotFound( Runtime* sandbox , const Value& obj , SSO* key ) {
  (void)sandbox;
  (void)obj;
  (void)key;
}
...
bool  InterpreterPropSetSSO( Runtime* sandbox , Value obj , SSO* key ,
                                                            Value* output ) {
  (void)sandbox;
  (void)obj;
  (void)key;
...
void InterpreterPropSetSSONotFound( Runtime* sandbox , const Value& obj ,
                                                       SSO* key ) {
  (void)sandbox;
  (void)obj;
  (void)key;
...
bool InterpreterIdxGet      ( Runtime* sandbox , const Value& obj ,
                                                 const Value& key ,
                                                 Value* output ) {
  (void)sandbox;
  (void)obj;
...
bool  InterpreterIdxGetI     ( Runtime* sandbox , const Value& obj ,
                                                  std::uint8_t idx ,
                                                  Value* output ) {
  (void)sandbox;
  (void)obj;
...
bool InterpreterIdxSet      ( Runtime* sandbox , const Value& obj ,
                                                 const Value& key ,
                                                 const Value& val ) {
  (void)sandbox;
  (void)obj;
...
bool InterpreterIdxSetI    ( Runtime* sandbox , const Value& obj  ,
                                                std::uint8_t idx ,
                                                const Value& val ) {
  (void)sandbox;
  (void)obj;
...
//|.actionlist actions
static const unsigned char actions[7256] = {
  ...
  231,255,77,139,93,0,77,139,148,253,195,233,72,141,116,36,56,76,137,84,36,
  56,255,73,141,20,206,73,141,12,222,255,232,251,1,0,255,72,184,237,237,252,
  255,208,255,133,192,15,132,244,19,139,69,0,72,15,182,200,72,131,197,4,193,
  232,8,65,252,255,36,207,255,249,248,22,73,137,172,253,36,233,76,137,231,73,
  139,52,198,255,77,139,93,0,77,139,148,253,203,233,72,141,84,36,56,76,137,
  84,36,56,255,249,248,23,73,137,172,253,36,233,76,137,231,73,141,52,222,73,
  141,20,198,73,141,12,206,255,249,248,24,73,137,172,253,36,233,76,137,231,
  255,232,251,1,1,255,249,248,25,73,137,172,253,36,233,76,137,231,73,141,52,
  198,255,77,139,93,0,77,139,148,253,203,233,76,137,84,36,56,72,141,84,36,56,
  255,249,248,26,73,137,172,253,36,233,72,15,182,216,193,232,8,15,182,204,37,
  252,255,0,0,0,76,137,231,73,141,52,198,73,141,20,206,73,141,12,222,255,249,
  248,27,73,137,172,253,36,233,76,137,231,255,232,251,1,2,255,252,233,244,19,
  255,249,248,28,73,137,172,253,36,233,76,137,231,255,73,141,20,198,73,141,
139,69,0,72,15,182,200,72,131,197,4,193,232,8,65,
  ...
  73,139,12,206,68,139,69,0,255,232,251,1,35,255,249,139,69,0,72,15,182,200,
  72,131,197,4,193,232,8,65,252,255,36,207,255,232,251,1,36,255,232,251,1,37,
  255,73,137,172,253,36,233,76,137,231,73,139,52,222,73,141,20,198,73,141,12,
  206,255,232,251,1,38,255,249,72,15,182,216,193,232,8,15,182,204,37,252,255,
  0,0,0,73,141,60,198,73,59,188,253,36,233,15,131,244,255,248,3,102,65,129,
  124,253,222,6,238,15,133,244,39,73,139,20,222,72,35,21,244,11,72,139,50,128,
  190,233,235,15,133,244,37,58,142,233,15,133,244,40,65,15,183,94,252,246,72,
  193,227,48,72,9,252,235,73,137,94,252,240,72,193,224,51,72,137,71,252,240,
  72,137,87,252,248,73,137,148,253,36,233,76,139,174,233,72,139,174,233,255,
  73,137,252,254,73,137,188,253,36,233,72,137,44,36,139,69,0,72,15,182,200,
  72,131,197,4,193,232,8,65,252,255,36,207,248,9,72,137,68,36,56,72,137,68,
  36,64,76,137,231,255,232,251,1,39,255,133,192,15,132,244,19,72,139,68,36,
  56,72,139,76,36,64,252,233,244,3,255,249,72,15,182,216,193,232,8,15,182,204,
  37,252,255,0,0,0,73,141,60,198,73,59,188,253,36,233,15,131,244,255,248,3,
  102,65,129,124,253,222,6,238,15,133,244,39,73,139,20,222,72,35,21,244,11,
  72,139,50,128,190,233,235,15,133,244,38,58,142,233,15,133,244,40,65,15,183,
  ...
  199,134,252,252,7,0,0,237,139,69,0,72,15,182,200,72,131,197,4,193,232,8,65,
  252,255,36,207,255,249,73,139,150,252,248,7,0,0,248,2,73,15,183,94,252,246,
  72,129,252,251,239,15,132,244,20,73,41,222,65,128,126,252,255,1,15,132,244,
  2,248,1,73,139,118,252,248,73,137,180,253,36,233,72,139,30,76,139,171,233,
  73,139,110,252,240,72,35,45,244,12,72,139,131,233,72,137,4,36,73,137,150,
  252,248,7,0,0,139,69,0,72,15,182,200,72,131,197,4,193,232,8,65,252,255,36,
  207,255,249,205,3,255
};

#line 654 "src/interpreter/bytecode-interpreter.dasc"
//|.globals GLBNAME_
enum {
...
#line 655 "src/interpreter/bytecode-interpreter.dasc"
...
#line 657 "src/interpreter/bytecode-interpreter.dasc"
//|.section code,data
#define DASM_SECTION_CODE	0
#define DASM_SECTION_DATA	1
#define DASM_MAXSECTION		2
#line 658 "src/interpreter/bytecode-interpreter.dasc"
...
#line 1224 "src/interpreter/bytecode-interpreter.dasc"
...
void GenerateHelper( BuildContext* bctx ) {
  ...
  //|  savepc
  //|  mov CARG1,RUNTIME
  dasm_put(Dst, 230,  INTERP_ARITH_REALL, RuntimeLayout::kCurPCOffset);
#line 1360 "src/interpreter/bytecode-interpreter.dasc"

  //|  LdRealV T2,ARG2F
  //|  lea CARG2,[SAVED_SLOT1]
  //|  mov qword [SAVED_SLOT1], T2
  dasm_put(Dst, 243, PrototypeLayout::kRealTableOffset);
#line 1364 "src/interpreter/bytecode-interpreter.dasc"
  ...
  dasm_put(Dst, 278, (unsigned int)(reinterpret_cast<std::uintptr_t>(InterpreterArithmetic)), (unsigned int)((reinterpret_cast<std::uintptr_t>(InterpreterArithmetic))>>32));
   }
...
#line 1369 "src/interpreter/bytecode-interpreter.dasc"
  ...
  dasm_put(Dst, 312,  INTERP_ARITH_REALR, RuntimeLayout::kCurPCOffset);
#line 1375 "src/interpreter/bytecode-interpreter.dasc"

  //|  LdRealV T2,ARG3F
  //|  lea CARG3,[SAVED_SLOT1]
  //|  mov qword [SAVED_SLOT1], T2
  dasm_put(Dst, 329, PrototypeLayout::kRealTableOffset);
...
#line 1383 "src/interpreter/bytecode-interpreter.dasc"
  ...
  //|  fcall InterpreterArithmetic
  dasm_put(Dst, 350,  INTERP_ARITH_VV, RuntimeLayout::kCurPCOffset);
   if(CheckAddress(reinterpret_cast<std::uintptr_t>(InterpreterArithmetic))) {
  dasm_put(Dst, 273);
   } else {
     lava_warn("%s","Function InterpreterArithmetic address is not in 0-2GB");
...
#line 1393 "src/interpreter/bytecode-interpreter.dasc"
  ...
  //|  savepc
  //|  mov CARG1, RUNTIME
  dasm_put(Dst, 375,  INTERP_POW_SLOWRV, RuntimeLayout::kCurPCOffset);
...
#line 1402 "src/interpreter/bytecode-interpreter.dasc"
  ...
  dasm_put(Dst, 278, (unsigned int)(reinterpret_cast<std::uintptr_t>(InterpreterPow)), (unsigned int)((reinterpret_cast<std::uintptr_t>(InterpreterPow))>>32));
   }
#line 1406 "src/interpreter/bytecode-interpreter.dasc"
  //|  retbool
  dasm_put(Dst, 286);
#line 1407 "src/interpreter/bytecode-interpreter.dasc"
  ...
  dasm_put(Dst, 393,  INTERP_POW_SLOWVR, RuntimeLayout::kCurPCOffset);
#line 1413 "src/interpreter/bytecode-interpreter.dasc"

  //|  LdRealV T2,ARG3F
  //|  mov qword [SAVED_SLOT1], T2
  //|  lea CARG3,[SAVED_SLOT1]
  dasm_put(Dst, 410, PrototypeLayout::kRealTableOffset);
...
#line 1421 "src/interpreter/bytecode-interpreter.dasc"
  ...
  //|  lea CARG4, [STK+ARG1F*8]
  //|  fcall InterpreterPow
  dasm_put(Dst, 431,  INTERP_POW_SLOWVV, RuntimeLayout::kCurPCOffset);
   if(CheckAddress(reinterpret_cast<std::uintptr_t>(InterpreterPow))) {
  dasm_put(Dst, 388);
   } else {
     lava_warn("%s","Function InterpreterPow address is not in 0-2GB");
...
#line 1432 "src/interpreter/bytecode-interpreter.dasc"
  ...
  dasm_put(Dst, 472,  MOD_BY_ZERO, RuntimeLayout::kCurPCOffset);
  ...
  dasm_put(Dst, 278, (unsigned int)(reinterpret_cast<std::uintptr_t>(InterpreterModByZero)), (unsigned int)((reinterpret_cast<std::uintptr_t>(InterpreterModByZero))>>32));
   }
...
#line 1442 "src/interpreter/bytecode-interpreter.dasc"
  ...
  //|  savepc
  //|  mov CARG1,RUNTIME
  dasm_put(Dst, 495,  INTERP_COMPARERV, RuntimeLayout::kCurPCOffset);
#line 1450 "src/interpreter/bytecode-interpreter.dasc"
  ...
  //|  mov qword  [SAVED_SLOT1], T2
  dasm_put(Dst, 243, PrototypeLayout::kRealTableOffset);
#line 1454 "src/interpreter/bytecode-interpreter.dasc"
  ...
  dasm_put(Dst, 278, (unsigned int)(reinterpret_cast<std::uintptr_t>(InterpreterCompare)), (unsigned int)((reinterpret_cast<std::uintptr_t>(InterpreterCompare))>>32));
   }
#line 1458 "src/interpreter/bytecode-interpreter.dasc"
  //|  retbool
  dasm_put(Dst, 286);
#line 1459 "src/interpreter/bytecode-interpreter.dasc"
  ...
  //|  mov CARG1,RUNTIME
  //|  lea CARG2, [STK+ARG2F*8]
  dasm_put(Dst, 522,  INTERP_COMPAREVR, RuntimeLayout::kCurPCOffset);
...
#line 1473 "src/interpreter/bytecode-interpreter.dasc"
  ...
  //|  lea CARG4, [STK+ARG1F*8]
  //|  fcall InterpreterCompare
  dasm_put(Dst, 539,  INTERP_COMPAREVV, RuntimeLayout::kCurPCOffset);
   if(CheckAddress(reinterpret_cast<std::uintptr_t>(InterpreterCompare))) {
  dasm_put(Dst, 517);
   } else {
     lava_warn("%s","Function InterpreterCompare address is not in 0-2GB");
...
#line 1483 "src/interpreter/bytecode-interpreter.dasc"
  ...
  dasm_put(Dst, 564,  INTERP_PROPGET, RuntimeLayout::kCurPCOffset, PrototypeLayout::kStringTableOffset);
  ...
  dasm_put(Dst, 278, (unsigned int)(reinterpret_cast<std::uintptr_t>(InterpreterPropGet)), (unsigned int)((reinterpret_cast<std::uintptr_t>(InterpreterPropGet))>>32));
   }
#line 1495 "src/interpreter/bytecode-interpreter.dasc"
  //|  retbool
  dasm_put(Dst, 286);
#line 1496 "src/interpreter/bytecode-interpreter.dasc"
  ...
  dasm_put(Dst, 278, (unsigned int)(reinterpret_cast<std::uintptr_t>(InterpreterPropNeedObject)), (unsigned int)((reinterpret_cast<std::uintptr_t>(InterpreterPropNeedObject))>>32));
   }
...
#line 1504 "src/interpreter/bytecode-interpreter.dasc"
  ...
  dasm_put(Dst, 278, (unsigned int)(reinterpret_cast<std::uintptr_t>(InterpreterIdxGetI)), (unsigned int)((reinterpret_cast<std::uintptr_t>(InterpreterIdxGetI))>>32));
   }
...
#line 1514 "src/interpreter/bytecode-interpreter.dasc"
  ...
  dasm_put(Dst, 278, (unsigned int)(reinterpret_cast<std::uintptr_t>(InterpreterIdxSetI)), (unsigned int)((reinterpret_cast<std::uintptr_t>(InterpreterIdxSetI))>>32));
   }
...
#line 1524 "src/interpreter/bytecode-interpreter.dasc"
  ...
  dasm_put(Dst, 278, (unsigned int)(reinterpret_cast<std::uintptr_t>(InterpreterIdxOutOfBound)), (unsigned int)((reinterpret_cast<std::uintptr_t>(InterpreterIdxOutOfBound))>>32));
   }
...
#line 1541 "src/interpreter/bytecode-interpreter.dasc"
  //|  jmp ->InterpFail
  dasm_put(Dst, 490);
#line 1542 "src/interpreter/bytecode-interpreter.dasc"
  ...
  dasm_put(Dst, 723,  INTERP_CALL, RuntimeLayout::kCurPCOffset);
  ...
  dasm_put(Dst, 278, (unsigned int)(reinterpret_cast<std::uintptr_t>(InterpreterCall)), (unsigned int)((reinterpret_cast<std::uintptr_t>(InterpreterCall))>>32));
   }
#line 1555 "src/interpreter/bytecode-interpreter.dasc"
  //|  retbool
  dasm_put(Dst, 286);
#line 1556 "src/interpreter/bytecode-interpreter.dasc"
  ...
  //|  mov CARG5L,1
  //|  fcall InterpreterCall
  dasm_put(Dst, 752,  INTERP_TCALL, RuntimeLayout::kCurPCOffset);
   if(CheckAddress(reinterpret_cast<std::uintptr_t>(InterpreterCall))) {
  dasm_put(Dst, 747);
   } else {
     lava_warn("%s","Function InterpreterCall address is not in 0-2GB");
...
#line 1567 "src/interpreter/bytecode-interpreter.dasc"
  ...
  dasm_put(Dst, 779,  INTERP_NEEDOBJECT, RuntimeLayout::kCurPCOffset);
  ...
  dasm_put(Dst, 278, (unsigned int)(reinterpret_cast<std::uintptr_t>(InterpreterCallNeedObject)), (unsigned int)((reinterpret_cast<std::uintptr_t>(InterpreterCallNeedObject))>>32));
   }
...
#line 1575 "src/interpreter/bytecode-interpreter.dasc"
  ...
  dasm_put(Dst, 801,  INTERP_ARGUMENTMISMATCH, RuntimeLayout::kCurPCOffset);
  ...
  dasm_put(Dst, 278, (unsigned int)(reinterpret_cast<std::uintptr_t>(InterpreterArgumentMismatch)), (unsigned int)((reinterpret_cast<std::uintptr_t>(InterpreterArgumentMismatch))>>32));
   }
...
#line 1608 "src/interpreter/bytecode-interpreter.dasc"
    ...
    case BC_LOAD1:
      ...
      //|  movsd qword[STK+ARG1F*8], xmm0
      //|  Dispatch
      dasm_put(Dst, 895,  bc, (unsigned int)((static_cast<std::uint64_t>(0x3ff00000)<<32)), (unsigned int)(((static_cast<std::uint64_t>(0x3ff00000)<<32))>>32));
#line 1616 "src/interpreter/bytecode-interpreter.dasc"
      break;
    ...
    case BC_LOADN1:
      ...
      //|  movsd qword[STK+ARG1F*8], xmm0
      //|  Dispatch
      dasm_put(Dst, 895,  bc, (unsigned int)((static_cast<std::uint64_t>(0xbff00000)<<32)), (unsigned int)(((static_cast<std::uint64_t>(0xbff00000)<<32))>>32));
#line 1624 "src/interpreter/bytecode-interpreter.dasc"
    ...
    case BC_LOADR:
      ...
      //|  movsd qword [STK+ARG1F*8],xmm0
      //|  Dispatch
      dasm_put(Dst, 935,  bc, PrototypeLayout::kRealTableOffset);
#line 1632 "src/interpreter/bytecode-interpreter.dasc"
    ...
    case BC_LOADNULL:
      ...
      //|  Dispatch
      dasm_put(Dst, 982,  bc, Value::FLAG_NULL);
#line 1639 "src/interpreter/bytecode-interpreter.dasc"
      break;
    ...
    case BC_LOADTRUE:
      ...
      //|  Dispatch
      dasm_put(Dst, 982,  bc, Value::FLAG_TRUE);
#line 1646 "src/interpreter/bytecode-interpreter.dasc"
    ...
    case BC_LOADFALSE:
      ...
      //|  Dispatch
      dasm_put(Dst, 982,  bc, Value::FLAG_FALSE);
#line 1653 "src/interpreter/bytecode-interpreter.dasc"
    ...
    case BC_LOADSTR:
      ...
      //|  Dispatch
      dasm_put(Dst, 1012,  bc, PrototypeLayout::kStringTableOffset);
#line 1661 "src/interpreter/bytecode-interpreter.dasc"
    ...
    case BC_LOADLIST0:
      ...
      dasm_put(Dst, 1060,  bc, RuntimeLayout::kCurPCOffset);
      ...
      dasm_put(Dst, 278, (unsigned int)(reinterpret_cast<std::uintptr_t>(InterpreterLoadList0)), (unsigned int)((reinterpret_cast<std::uintptr_t>(InterpreterLoadList0))>>32));
       }
...
#line 1688 "src/interpreter/bytecode-interpreter.dasc"
    ...
    case BC_LOADLIST1:
      ...
      dasm_put(Dst, 1083, bc, RuntimeLayout::kCurPCOffset);
      ...
      dasm_put(Dst, 278, (unsigned int)(reinterpret_cast<std::uintptr_t>(InterpreterLoadList1)), (unsigned int)((reinterpret_cast<std::uintptr_t>(InterpreterLoadList1))>>32));
       }
...
#line 1698 "src/interpreter/bytecode-interpreter.dasc"
    ...
    case BC_LOADLIST2:
      ...
      dasm_put(Dst, 1113, bc, RuntimeLayout::kCurPCOffset);
      ...
      dasm_put(Dst, 278, (unsigned int)(reinterpret_cast<std::uintptr_t>(InterpreterLoadList2)), (unsigned int)((reinterpret_cast<std::uintptr_t>(InterpreterLoadList2))>>32));
       }
#line 1708 "src/interpreter/bytecode-interpreter.dasc"
      //|  Dispatch
      dasm_put(Dst, 149);
#line 1709 "src/interpreter/bytecode-interpreter.dasc"
      break;
    case BC_NEWLIST:
      //|=>bc:
      //|  instr_B
      ...
      dasm_put(Dst, 1157, bc, RuntimeLayout::kCurPCOffset);
      ...
      dasm_put(Dst, 278, (unsigned int)(reinterpret_cast<std::uintptr_t>(InterpreterNewList)), (unsigned int)((reinterpret_cast<std::uintptr_t>(InterpreterNewList))>>32));
       }
...
#line 1719 "src/interpreter/bytecode-interpreter.dasc"
    ...
    case BC_ADDLIST:
      ...
      dasm_put(Dst, 1186, bc, RuntimeLayout::kCurPCOffset);
      ...
      dasm_put(Dst, 278, (unsigned int)(reinterpret_cast<std::uintptr_t>(InterpreterAddList)), (unsigned int)((reinterpret_cast<std::uintptr_t>(InterpreterAddList))>>32));
       }
...
#line 1730 "src/interpreter/bytecode-interpreter.dasc"
    ...
    case BC_LOADOBJ0:
      ...
      dasm_put(Dst, 278, (unsigned int)(reinterpret_cast<std::uintptr_t>(InterpreterLoadObj0)), (unsigned int)((reinterpret_cast<std::uintptr_t>(InterpreterLoadObj0))>>32));
       }
#line 1738 "src/interpreter/bytecode-interpreter.dasc"
      //|  Dispatch
      dasm_put(Dst, 149);
#line 1739 "src/interpreter/bytecode-interpreter.dasc"
      break;
    case BC_LOADOBJ1:
      //|=>bc:
      //|  instr_D
      ...
      dasm_put(Dst, 278, (unsigned int)(reinterpret_cast<std::uintptr_t>(InterpreterLoadObj1)), (unsigned int)((reinterpret_cast<std::uintptr_t>(InterpreterLoadObj1))>>32));
       }
#line 1749 "src/interpreter/bytecode-interpreter.dasc"
      //|  retbool
      dasm_put(Dst, 286);
#line 1750 "src/interpreter/bytecode-interpreter.dasc"
      break;
    case BC_NEWOBJ:
      //|=>bc:
      //|  instr_B
      ...
      dasm_put(Dst, 278, (unsigned int)(reinterpret_cast<std::uintptr_t>(InterpreterNewObj)), (unsigned int)((reinterpret_cast<std::uintptr_t>(InterpreterNewObj))>>32));
       }
...
#line 1760 "src/interpreter/bytecode-interpreter.dasc"
    ...
    case BC_ADDOBJ:
      ...
      dasm_put(Dst, 278, (unsigned int)(reinterpret_cast<std::uintptr_t>(InterpreterAddObj)), (unsigned int)((reinterpret_cast<std::uintptr_t>(InterpreterAddObj))>>32));
       }
#line 1770 "src/interpreter/bytecode-interpreter.dasc"
      //|  retbool
      dasm_put(Dst, 286);
#line 1771 "src/interpreter/bytecode-interpreter.dasc"
      break;
    case BC_LOADCLS:
      //|=>bc:
      //|  instr_C
      ...
      dasm_put(Dst, 1246, bc, RuntimeLayout::kCurPCOffset);
      ...
      dasm_put(Dst, 278, (unsigned int)(reinterpret_cast<std::uintptr_t>(InterpreterLoadCls)), (unsigned int)((reinterpret_cast<std::uintptr_t>(InterpreterLoadCls))>>32));
       }
#line 1780 "src/interpreter/bytecode-interpreter.dasc"
      //|  Dispatch
      dasm_put(Dst, 149);
#line 1781 "src/interpreter/bytecode-interpreter.dasc"
      break;
    case BC_INITCLS:
      //|=>bc:
      //|  instr_G
      ...
      dasm_put(Dst, 1275, bc, RuntimeLayout::kCurPCOffset);
      ...
      dasm_put(Dst, 278, (unsigned int)(reinterpret_cast<std::uintptr_t>(InterpreterInitCls)), (unsigned int)((reinterpret_cast<std::uintptr_t>(InterpreterInitCls))>>32));
       }
...
#line 1790 "src/interpreter/bytecode-interpreter.dasc"
    ...
    case BC_ADDRV:
      ...
      dasm_put(Dst, 1297, bc, Value::FLAG_REAL, PrototypeLayout::kRealTableOffset);
#line 1820 "src/interpreter/bytecode-interpreter.dasc"
    ...
    case BC_SUBRV:
      ...
      dasm_put(Dst, 1384, bc, Value::FLAG_REAL, PrototypeLayout::kRealTableOffset);
#line 1825 "src/interpreter/bytecode-interpreter.dasc"
    ...
    case BC_MULRV:
      ...
      dasm_put(Dst, 1471, bc, Value::FLAG_REAL, PrototypeLayout::kRealTableOffset);
#line 1830 "src/interpreter/bytecode-interpreter.dasc"
    ...
    case BC_DIVRV:
      ...
      dasm_put(Dst, 1558, bc, Value::FLAG_REAL, PrototypeLayout::kRealTableOffset);
#line 1835 "src/interpreter/bytecode-interpreter.dasc"
    ...
    case BC_ADDVR:
      ...
      dasm_put(Dst, 1645,  bc, Value::FLAG_REAL, PrototypeLayout::kRealTableOffset);
#line 1865 "src/interpreter/bytecode-interpreter.dasc"
    ...
    case BC_SUBVR:
      ...
      dasm_put(Dst, 1733,  bc, Value::FLAG_REAL, PrototypeLayout::kRealTableOffset);
#line 1870 "src/interpreter/bytecode-interpreter.dasc"
    ...
    case BC_MULVR:
      ...
      dasm_put(Dst, 1821,  bc, Value::FLAG_REAL, PrototypeLayout::kRealTableOffset);
#line 1875 "src/interpreter/bytecode-interpreter.dasc"
    ...
    case BC_DIVVR:
      ...
      dasm_put(Dst, 1909,  bc, Value::FLAG_REAL, PrototypeLayout::kRealTableOffset);
#line 1880 "src/interpreter/bytecode-interpreter.dasc"
    ...
    case BC_ADDVV:
      ...
      dasm_put(Dst, 1997,  BC_ADDVV, Value::FLAG_REAL, Value::FLAG_REAL);
#line 1914 "src/interpreter/bytecode-interpreter.dasc"
      break;
    case BC_SUBVV:
      //|  arith_vv BC_SUBVV,subsd
      dasm_put(Dst, 2079,  BC_SUBVV, Value::FLAG_REAL, Value::FLAG_REAL);
#line 1917 "src/interpreter/bytecode-interpreter.dasc"
      break;
    case BC_MULVV:
      //|  arith_vv BC_MULVV,mulsd
      dasm_put(Dst, 2161,  BC_MULVV, Value::FLAG_REAL, Value::FLAG_REAL);
#line 1920 "src/interpreter/bytecode-interpreter.dasc"
      break;
    case BC_DIVVV:
      //|  arith_vv BC_DIVVV,divsd
      dasm_put(Dst, 2243,  BC_DIVVV, Value::FLAG_REAL, Value::FLAG_REAL);
#line 1923 "src/interpreter/bytecode-interpreter.dasc"
    ...
    case BC_MODVR:
      //|=>bc:
      //|  instr_D
      dasm_put(Dst, 2325, bc);
#line 1937 "src/interpreter/bytecode-interpreter.dasc"

      //|  cmp dword [STK+ARG2F*8+4], Value::FLAG_REAL
      //|  jnb ->InterpArithVV
      dasm_put(Dst, 2343, Value::FLAG_REAL);
#line 1940 "src/interpreter/bytecode-interpreter.dasc"

      //|  LdReal2Int ARG3,ARG3F,T0
      //|  cvtsd2si eax ,qword [STK+ARG2F*8]  // ARG2F == rax
      dasm_put(Dst, 2355, PrototypeLayout::kRealTableOffset);
#line 1943 "src/interpreter/bytecode-interpreter.dasc"
...
#line 1958 "src/interpreter/bytecode-interpreter.dasc"
      ...
      //|  jnb ->InterpArithVV
      dasm_put(Dst, 2419, Value::FLAG_REAL);
#line 1961 "src/interpreter/bytecode-interpreter.dasc"

      //|  LdReal2Int eax,ARG2F,T0  // ARG2F == rax
      //|  cvtsd2si ARG3 ,qword [STK+ARG3F*8]
      dasm_put(Dst, 2431, PrototypeLayout::kRealTableOffset);
#line 1964 "src/interpreter/bytecode-interpreter.dasc"
...
#line 1974 "src/interpreter/bytecode-interpreter.dasc"
    ...
    case BC_MODVV:
      ...
      //|  cmp dword [STK+ARG2F*8+4] , Value::FLAG_REAL
      //|  jnb ->InterpArithVV
      dasm_put(Dst, 2451, bc , Value::FLAG_REAL);
...
#line 1988 "src/interpreter/bytecode-interpreter.dasc"
      ...
      //|.endif
      dasm_put(Dst, 2375);
#line 1993 "src/interpreter/bytecode-interpreter.dasc"
...
#line 1998 "src/interpreter/bytecode-interpreter.dasc"
    ...
    case BC_POWRV:
      ...
      dasm_put(Dst, 2495,  bc, PrototypeLayout::kRealTableOffset, Value::FLAG_REAL);
       if(CheckAddress(reinterpret_cast<std::uintptr_t>(pow))) {
      dasm_put(Dst, 2546);
       } else {
         lava_warn("%s","Function pow address is not in 0-2GB");
      dasm_put(Dst, 278, (unsigned int)(reinterpret_cast<std::uintptr_t>(pow)), (unsigned int)((reinterpret_cast<std::uintptr_t>(pow))>>32));
       }
      dasm_put(Dst, 868);
#line 2027 "src/interpreter/bytecode-interpreter.dasc"
      break;
    ...
    case BC_POWVR:
      ...
      dasm_put(Dst, 2551,  bc, PrototypeLayout::kRealTableOffset, Value::FLAG_REAL);
       if(CheckAddress(reinterpret_cast<std::uintptr_t>(pow))) {
      dasm_put(Dst, 2546);
       } else {
         lava_warn("%s","Function pow address is not in 0-2GB");
...
#line 2034 "src/interpreter/bytecode-interpreter.dasc"
    ...
    case BC_POWVV:
      //|=> bc:
      //|  jmp ->InterpPowSlowVV
      dasm_put(Dst, 2602,  bc);
#line 2039 "src/interpreter/bytecode-interpreter.dasc"
      break;
    ...
    case BC_LTRV:
      ...
      dasm_put(Dst, 2608, bc, Value::FLAG_REAL, PrototypeLayout::kRealTableOffset, Value::FLAG_TRUE, Value::FLAG_FALSE);
#line 2072 "src/interpreter/bytecode-interpreter.dasc"
      break;
    case BC_LERV:
      //|=> bc:
      //|  comp_xv BC_LERV,InterpCompareRV,ja
      dasm_put(Dst, 2699,  bc, Value::FLAG_REAL, PrototypeLayout::kRealTableOffset, Value::FLAG_TRUE, Value::FLAG_FALSE);
#line 2076 "src/interpreter/bytecode-interpreter.dasc"
      break;
    case BC_GTRV:
      //|=>bc:
      //|  comp_xv BC_GTRV,InterpCompareRV,jbe
      dasm_put(Dst, 2790, bc, Value::FLAG_REAL, PrototypeLayout::kRealTableOffset, Value::FLAG_TRUE, Value::FLAG_FALSE);
#line 2080 "src/interpreter/bytecode-interpreter.dasc"
      break;
    case BC_GERV:
      //|=> bc:
      //|  comp_xv BC_GERV,InterpCompareRV,jb
      dasm_put(Dst, 2881,  bc, Value::FLAG_REAL, PrototypeLayout::kRealTableOffset, Value::FLAG_TRUE, Value::FLAG_FALSE);
#line 2084 "src/interpreter/bytecode-interpreter.dasc"
      break;
    case BC_EQRV:
      //|=> bc:
      //|  comp_xv BC_EQRV,InterpCompareRV,jne
      dasm_put(Dst, 2972,  bc, Value::FLAG_REAL, PrototypeLayout::kRealTableOffset, Value::FLAG_TRUE, Value::FLAG_FALSE);
#line 2088 "src/interpreter/bytecode-interpreter.dasc"
      break;
    case BC_NERV:
      //|=> bc:
      //|  comp_xv BC_NERV,InterpCompareRV,je
      dasm_put(Dst, 3063,  bc, Value::FLAG_REAL, PrototypeLayout::kRealTableOffset, Value::FLAG_TRUE, Value::FLAG_FALSE);
#line 2092 "src/interpreter/bytecode-interpreter.dasc"
    ...
    case BC_LTVR:
      ...
      dasm_put(Dst, 3154, bc, Value::FLAG_REAL, PrototypeLayout::kRealTableOffset, Value::FLAG_TRUE, Value::FLAG_FALSE);
#line 2118 "src/interpreter/bytecode-interpreter.dasc"
      break;
    case BC_LEVR:
      //|=>bc:
      //|  comp_vx BC_LEVR,InterpCompareVR,ja
      dasm_put(Dst, 3250, bc, Value::FLAG_REAL, PrototypeLayout::kRealTableOffset, Value::FLAG_TRUE, Value::FLAG_FALSE);
#line 2122 "src/interpreter/bytecode-interpreter.dasc"
      break;
    case BC_GTVR:
      //|=>bc:
      //|  comp_vx BC_GTVR,InterpCompareVR,jbe
      dasm_put(Dst, 3346, bc, Value::FLAG_REAL, PrototypeLayout::kRealTableOffset, Value::FLAG_TRUE, Value::FLAG_FALSE);
#line 2126 "src/interpreter/bytecode-interpreter.dasc"
      break;
    case BC_GEVR:
      //|=>bc:
      //|  comp_vx BC_GEVR,InterpCompareVR,jb
      dasm_put(Dst, 3442, bc, Value::FLAG_REAL, PrototypeLayout::kRealTableOffset, Value::FLAG_TRUE, Value::FLAG_FALSE);
#line 2130 "src/interpreter/bytecode-interpreter.dasc"
      break;
    case BC_EQVR:
      //|=>bc:
      //|  comp_vx BC_EQVR,InterpCompareVR,jne
      dasm_put(Dst, 3538, bc, Value::FLAG_REAL, PrototypeLayout::kRealTableOffset, Value::FLAG_TRUE, Value::FLAG_FALSE);
#line 2134 "src/interpreter/bytecode-interpreter.dasc"
      break;
    case BC_NEVR:
      //|=>bc:
      //|  comp_vx BC_NEVR,InterpCompareVR,je
      dasm_put(Dst, 3634, bc, Value::FLAG_REAL, PrototypeLayout::kRealTableOffset, Value::FLAG_TRUE, Value::FLAG_FALSE);
#line 2138 "src/interpreter/bytecode-interpreter.dasc"
    ...
    case BC_LTVV:
      //|=>bc:
      //|  comp_vv,BC_LTVV,jae
      dasm_put(Dst, 3730, bc, Value::FLAG_REAL, Value::FLAG_REAL, Value::FLAG_TRUE, Value::FLAG_FALSE);
#line 2170 "src/interpreter/bytecode-interpreter.dasc"
      break;
    case BC_LEVV:
      //|=>bc:
      //|  comp_vv,BC_LEVV,ja
      dasm_put(Dst, 3826, bc, Value::FLAG_REAL, Value::FLAG_REAL, Value::FLAG_TRUE, Value::FLAG_FALSE);
#line 2174 "src/interpreter/bytecode-interpreter.dasc"
      break;
    case BC_GTVV:
      //|=>bc:
      //|  comp_vv,BC_GTVV,jbe
      dasm_put(Dst, 3922, bc, Value::FLAG_REAL, Value::FLAG_REAL, Value::FLAG_TRUE, Value::FLAG_FALSE);
#line 2178 "src/interpreter/bytecode-interpreter.dasc"
      break;
    case BC_GEVV:
      //|=>bc:
      //|  comp_vv,BC_GEVV,jb
      dasm_put(Dst, 4018, bc, Value::FLAG_REAL, Value::FLAG_REAL, Value::FLAG_TRUE, Value::FLAG_FALSE);
#line 2182 "src/interpreter/bytecode-interpreter.dasc"
    ...
    case BC_EQVV:
      ...
      dasm_put(Dst, 4114, bc, Value::FLAG_REAL, Value::FLAG_REAL, Value::FLAG_TRUE, Value::FLAG_FALSE, Value::FLAG_HEAP);
      dasm_put(Dst, 4252, Value::FLAG_HEAP, Value::FLAG_TRUE, Value::FLAG_FALSE, -HOH_TYPE_OFFSET, SSO_BIT_PATTERN, -HOH_TYPE_OFFSET, SSO_BIT_PATTERN);
      dasm_put(Dst, 4317, Value::FLAG_TRUE, Value::FLAG_FALSE);
       if(CheckAddress(reinterpret_cast<std::uintptr_t>(InterpreterCompare))) {
      dasm_put(Dst, 517);
       } else {
         lava_warn("%s","Function InterpreterCompare address is not in 0-2GB");
...
#line 2265 "src/interpreter/bytecode-interpreter.dasc"
    ...
    case BC_NEVV:
      ...
      dasm_put(Dst, 4114, bc, Value::FLAG_REAL, Value::FLAG_REAL, Value::FLAG_FALSE, Value::FLAG_TRUE, Value::FLAG_HEAP);
      dasm_put(Dst, 4252, Value::FLAG_HEAP, Value::FLAG_FALSE, Value::FLAG_TRUE, -HOH_TYPE_OFFSET, SSO_BIT_PATTERN, -HOH_TYPE_OFFSET, SSO_BIT_PATTERN);
      dasm_put(Dst, 4317, Value::FLAG_FALSE, Value::FLAG_TRUE);
       if(CheckAddress(reinterpret_cast<std::uintptr_t>(InterpreterCompare))) {
      dasm_put(Dst, 517);
       } else {
         lava_warn("%s","Function InterpreterCompare address is not in 0-2GB");
...
#line 2269 "src/interpreter/bytecode-interpreter.dasc"
    ...
    case BC_EQSV:
      ...
      dasm_put(Dst, 4367,  bc, PrototypeLayout::kStringTableOffset, -HOH_TYPE_OFFSET, SSO_BIT_PATTERN, Value::FLAG_HEAP, -HOH_TYPE_OFFSET, SSO_BIT_PATTERN, Value::FLAG_TRUE);
      dasm_put(Dst, 4470, Value::FLAG_FALSE);
#line 2332 "src/interpreter/bytecode-interpreter.dasc"
      break;
    case BC_EQVS:
      //|=> bc:
      //|  eq_vs BC_EQVS,InterpCompareVS,cmove,jne
      dasm_put(Dst, 4504,  bc, PrototypeLayout::kStringTableOffset, Value::FLAG_HEAP, -HOH_TYPE_OFFSET, SSO_BIT_PATTERN, -HOH_TYPE_OFFSET, SSO_BIT_PATTERN, Value::FLAG_TRUE);
      dasm_put(Dst, 4608, Value::FLAG_FALSE);
#line 2336 "src/interpreter/bytecode-interpreter.dasc"
      break;
    case BC_NESV:
      //|=>bc:
      //|  eq_sv BC_NESV,InterpCompareSV,cmovne,je
      dasm_put(Dst, 4642, bc, PrototypeLayout::kStringTableOffset, -HOH_TYPE_OFFSET, SSO_BIT_PATTERN, Value::FLAG_HEAP, -HOH_TYPE_OFFSET, SSO_BIT_PATTERN, Value::FLAG_TRUE);
      dasm_put(Dst, 4470, Value::FLAG_FALSE);
#line 2340 "src/interpreter/bytecode-interpreter.dasc"
    ...
    case BC_NEVS:
      ...
      dasm_put(Dst, 4745, bc, PrototypeLayout::kStringTableOffset, Value::FLAG_HEAP, -HOH_TYPE_OFFSET, SSO_BIT_PATTERN, -HOH_TYPE_OFFSET, SSO_BIT_PATTERN, Value::FLAG_TRUE);
      dasm_put(Dst, 4608, Value::FLAG_FALSE);
#line 2344 "src/interpreter/bytecode-interpreter.dasc"
      break;
    ...
    case BC_NEGATE:
      ...
      //|  cmp dword [STK+ARG2F*8+4], Value::FLAG_REAL
      //|  jnb >8
      dasm_put(Dst, 4849,  bc, Value::FLAG_REAL);
#line 2359 "src/interpreter/bytecode-interpreter.dasc"
      ...
      //|  movsd qword [STK+ARG1F*8], xmm0
      //|  Dispatch
      dasm_put(Dst, 4868, (unsigned int)((static_cast<std::uint64_t>(0x80000000)<<32)), (unsigned int)(((static_cast<std::uint64_t>(0x80000000)<<32))>>32));
#line 2365 "src/interpreter/bytecode-interpreter.dasc"
      ...
      dasm_put(Dst, 278, (unsigned int)(reinterpret_cast<std::uintptr_t>(InterpreterNegateFail)), (unsigned int)((reinterpret_cast<std::uintptr_t>(InterpreterNegateFail))>>32));
       }
...
#line 2371 "src/interpreter/bytecode-interpreter.dasc"
    ...
    case BC_NOT:
      ...
      dasm_put(Dst, 4930,  bc, Value::FLAG_FALSE);
#line 2377 "src/interpreter/bytecode-interpreter.dasc"
      ...
      //|  Dispatch
      dasm_put(Dst, 4940, Value::FLAG_HEAP, Value::FLAG_FALSECOND);
#line 2385 "src/interpreter/bytecode-interpreter.dasc"
      break;
    ...
    case BC_JMPT:
      ...
      //|1:  // fallthrough
      //|  Dispatch
      dasm_put(Dst, 4991, bc, Value::FLAG_HEAP, Value::FLAG_FALSECOND);
#line 2408 "src/interpreter/bytecode-interpreter.dasc"
      break;
    ...
    case BC_JMPF:
      ...
      //|2: // fallthrough
      //|  Dispatch
      dasm_put(Dst, 5054, bc, Value::FLAG_HEAP, Value::FLAG_FALSECOND);
#line 2420 "src/interpreter/bytecode-interpreter.dasc"
    ...
    case BC_AND:
      ...
      //|1: // fallthrough
      //|  Dispatch
      dasm_put(Dst, 5115, bc, Value::FLAG_HEAP, Value::FLAG_FALSECOND);
#line 2432 "src/interpreter/bytecode-interpreter.dasc"
      break;
    ...
    case BC_OR:
      ...
      //|  Dispatch
      dasm_put(Dst, 4991, bc, Value::FLAG_HEAP, Value::FLAG_FALSECOND);
#line 2445 "src/interpreter/bytecode-interpreter.dasc"
      break;
...
#line 2456 "src/interpreter/bytecode-interpreter.dasc"
    ...
    case BC_PROPGETSSO:
      ...
      //|  instr_D
      dasm_put(Dst, 2325, bc);
#line 2510 "src/interpreter/bytecode-interpreter.dasc"
      // Check ARG2F points to a *Object*
      //|  cmp word [STK+ARG2F*8+6], Value::FLAG_HEAP
      //|  jne ->InterpPropNeedObject
      dasm_put(Dst, 5209, Value::FLAG_HEAP);
#line 2513 "src/interpreter/bytecode-interpreter.dasc"

      //|  mov CARG2, qword [STK+ARG2F*8]
      //|  mov ARG2F, CARG2
      //|  CheckObj ARG2F, >9
      dasm_put(Dst, 5222, -HOH_TYPE_OFFSET, OBJECT_BIT_PATTERN);
#line 2517 "src/interpreter/bytecode-interpreter.dasc"
      ...
      dasm_put(Dst, 5247, ObjectLayout::kMapOffset);
#line 2521 "src/interpreter/bytecode-interpreter.dasc"

      // Load SSO/key into ARG3F
      //|  LdSSO ARG3F,ARG3F,T0
      dasm_put(Dst, 5255, PrototypeLayout::kSSOTableOffset);
#line 2524 "src/interpreter/bytecode-interpreter.dasc"

      // Do the search
      //|  objfind_sso ARG2F,ARG3F,>8,getsso_found
      dasm_put(Dst, 5268, SSOLayout::kHashOffset, MapLayout::kMaskOffset, MapLayout::kArrayOffset, MapEntryLayout::kFlagOffset, (Map::Entry::kUseButNotDelBit), MapEntryLayout::kKeyOffset, -HOH_TYPE_OFFSET, SSO_BIT_PATTERN, MapEntryLayout::kValueOffset, (Map::Entry::kMoreBit));
      dasm_put(Dst, 5366, (bits::BitOn<std::uint32_t,0,29>::value));
#line 2527 "src/interpreter/bytecode-interpreter.dasc"
      ...
      dasm_put(Dst, 278, (unsigned int)(reinterpret_cast<std::uintptr_t>(InterpreterPropGetSSONotFound)), (unsigned int)((reinterpret_cast<std::uintptr_t>(InterpreterPropGetSSONotFound))>>32));
       }
...
#line 2534 "src/interpreter/bytecode-interpreter.dasc"
      ...
      dasm_put(Dst, 278, (unsigned int)(reinterpret_cast<std::uintptr_t>(InterpreterPropGetSSO)), (unsigned int)((reinterpret_cast<std::uintptr_t>(InterpreterPropGetSSO))>>32));
       }
...
#line 2541 "src/interpreter/bytecode-interpreter.dasc"
    ...
    case BC_PROPGET:
      ...
      //|  lea   CARG4, [STK+ARG3F*8]
      //|  fcall InterpreterPropGet
      dasm_put(Dst, 5428, bc, PrototypeLayout::kStringTableOffset);
       if(CheckAddress(reinterpret_cast<std::uintptr_t>(InterpreterPropGet))) {
      dasm_put(Dst, 597);
       } else {
         lava_warn("%s","Function InterpreterPropGet address is not in 0-2GB");
...
#line 2554 "src/interpreter/bytecode-interpreter.dasc"
    ...
    case BC_PROPSETSSO:
      ...
      //|  Dispatch
      //|.endmacro
      dasm_put(Dst, 5469, bc);
#line 2563 "src/interpreter/bytecode-interpreter.dasc"
      ...
      //|  mov ARG1F, CARG2
      //|  CheckObj ARG1F, >9
      dasm_put(Dst, 5471, Value::FLAG_HEAP, -HOH_TYPE_OFFSET, OBJECT_BIT_PATTERN);
#line 2570 "src/interpreter/bytecode-interpreter.dasc"
      ...
      dasm_put(Dst, 5524, ObjectLayout::kMapOffset, PrototypeLayout::kSSOTableOffset);
#line 2575 "src/interpreter/bytecode-interpreter.dasc"

      //|  objfind_sso ARG1F,ARG2F,>8,setsso_found
      dasm_put(Dst, 5544, SSOLayout::kHashOffset, MapLayout::kMaskOffset, MapLayout::kArrayOffset, MapEntryLayout::kFlagOffset, (Map::Entry::kUseButNotDelBit), MapEntryLayout::kKeyOffset, -HOH_TYPE_OFFSET, SSO_BIT_PATTERN, MapEntryLayout::kValueOffset, (Map::Entry::kMoreBit));
      dasm_put(Dst, 5366, (bits::BitOn<std::uint32_t,0,29>::value));
#line 2577 "src/interpreter/bytecode-interpreter.dasc"
      ...
      dasm_put(Dst, 278, (unsigned int)(reinterpret_cast<std::uintptr_t>(InterpreterPropSetSSONotFound)), (unsigned int)((reinterpret_cast<std::uintptr_t>(InterpreterPropSetSSONotFound))>>32));
       }
#line 2583 "src/interpreter/bytecode-interpreter.dasc"
      //|  jmp ->InterpFail
      dasm_put(Dst, 490);
#line 2584 "src/interpreter/bytecode-interpreter.dasc"
      ...
      dasm_put(Dst, 278, (unsigned int)(reinterpret_cast<std::uintptr_t>(InterpreterPropSetSSO)), (unsigned int)((reinterpret_cast<std::uintptr_t>(InterpreterPropSetSSO))>>32));
       }
#line 2590 "src/interpreter/bytecode-interpreter.dasc"
      //|  retbool
      dasm_put(Dst, 286);
#line 2591 "src/interpreter/bytecode-interpreter.dasc"
    ...
    case BC_PROPSET:
      ...
      dasm_put(Dst, 5664, bc, PrototypeLayout::kStringTableOffset);
      ...
      dasm_put(Dst, 278, (unsigned int)(reinterpret_cast<std::uintptr_t>(InterpreterPropSet)), (unsigned int)((reinterpret_cast<std::uintptr_t>(InterpreterPropSet))>>32));
       }
#line 2601 "src/interpreter/bytecode-interpreter.dasc"
      //|  retbool
      dasm_put(Dst, 286);
#line 2602 "src/interpreter/bytecode-interpreter.dasc"
      break;
    ...
    case BC_IDXGET:
      ...
      //|  cmp dword [STK+ARG3F*8+4], Value::FLAG_REAL
      //|  jnb >1
      //|  cvtsd2si ARG3F, qword [STK+ARG3F*8]
      //|  test ARG3,ARG3
      //|  js ->InterpIdxOutOfBoundGet // out of bound
      dasm_put(Dst, 5710, bc, Value::FLAG_REAL);
#line 2632 "src/interpreter/bytecode-interpreter.dasc"
      ...
      dasm_put(Dst, 5752, Value::FLAG_HEAP, -HOH_TYPE_OFFSET, LIST_BIT_PATTERN, ListLayout::kSizeOffset, ListLayout::kSliceOffset, SliceLayout::kArrayOffset);
#line 2635 "src/interpreter/bytecode-interpreter.dasc"
      ...
      dasm_put(Dst, 278, (unsigned int)(reinterpret_cast<std::uintptr_t>(InterpreterIdxGet)), (unsigned int)((reinterpret_cast<std::uintptr_t>(InterpreterIdxGet))>>32));
       }
#line 2643 "src/interpreter/bytecode-interpreter.dasc"
      //|  retbool
      dasm_put(Dst, 286);
#line 2644 "src/interpreter/bytecode-interpreter.dasc"
      break;
    ...
    case BC_IDXGETI:
      ...
      //|  instr_D
      //|  index_list,InterpIdxOutOfBoundGet,->InterpIdxGetI
      dasm_put(Dst, 5851, bc, Value::FLAG_HEAP, -HOH_TYPE_OFFSET, LIST_BIT_PATTERN, ListLayout::kSizeOffset, ListLayout::kSliceOffset, SliceLayout::kArrayOffset);
#line 2650 "src/interpreter/bytecode-interpreter.dasc"
      break;
...
#line 2675 "src/interpreter/bytecode-interpreter.dasc"
      ...
      //|  cmp dword [STK+ARG2F*8+4], Value::FLAG_REAL
      //|  jnb >1
      dasm_put(Dst, 5944, Value::FLAG_REAL);
#line 2679 "src/interpreter/bytecode-interpreter.dasc"
      // conversion
      //|  cvtsd2si ARG2F, qword [STK+ARG2F*8]
      //|  test ARG2, ARG2
      //|  jz ->InterpIdxOutOfBoundSet
      dasm_put(Dst, 5956);
#line 2683 "src/interpreter/bytecode-interpreter.dasc"

      //|  set_list,InterpIdxOutOfBoundSet,->InterpIdxSetI
      dasm_put(Dst, 5970, Value::FLAG_HEAP, -HOH_TYPE_OFFSET, LIST_BIT_PATTERN, ListLayout::kSizeOffset, ListLayout::kSliceOffset, SliceLayout::kArrayOffset);
#line 2685 "src/interpreter/bytecode-interpreter.dasc"
      ...
      dasm_put(Dst, 6046, RuntimeLayout::kCurPCOffset);
      ...
      dasm_put(Dst, 278, (unsigned int)(reinterpret_cast<std::uintptr_t>(InterpreterIdxSet)), (unsigned int)((reinterpret_cast<std::uintptr_t>(InterpreterIdxSet))>>32));
       }
...
#line 2694 "src/interpreter/bytecode-interpreter.dasc"
    ...
    case BC_IDXSETI:
      ...
      //|  set_list,InterpIdxOutOfBoundSet,->InterpIdxSetI
      dasm_put(Dst, 6075, bc, Value::FLAG_HEAP, -HOH_TYPE_OFFSET, LIST_BIT_PATTERN, ListLayout::kSizeOffset, ListLayout::kSliceOffset, SliceLayout::kArrayOffset);
#line 2701 "src/interpreter/bytecode-interpreter.dasc"
    ...
    case BC_UVGET:
      ...
      //|  mov  qword [STK+ARG1F*8], LREG
      //|  Dispatch
      dasm_put(Dst, 6168, bc, RuntimeLayout::kCurClsOffset, ClosureLayout::kUpValueOffset);
#line 2709 "src/interpreter/bytecode-interpreter.dasc"
    ...
    case BC_UVSET:
      ...
      //|  StUV ARG1F,RREG
      //|  Dispatch
      dasm_put(Dst, 6214, bc, RuntimeLayout::kCurClsOffset, ClosureLayout::kUpValueOffset);
#line 2717 "src/interpreter/bytecode-interpreter.dasc"
    ...
    case BC_GSET:
      ...
      dasm_put(Dst, 6260, bc, RuntimeLayout::kCurPCOffset, PrototypeLayout::kStringTableOffset);
      ...
      dasm_put(Dst, 278, (unsigned int)(reinterpret_cast<std::uintptr_t>(InterpreterGSet)), (unsigned int)((reinterpret_cast<std::uintptr_t>(InterpreterGSet))>>32));
       }
...
#line 2728 "src/interpreter/bytecode-interpreter.dasc"
    ...
    case BC_GGET:
      ...
      dasm_put(Dst, 6299, bc, RuntimeLayout::kCurPCOffset, PrototypeLayout::kStringTableOffset);
      ...
      dasm_put(Dst, 278, (unsigned int)(reinterpret_cast<std::uintptr_t>(InterpreterGGet)), (unsigned int)((reinterpret_cast<std::uintptr_t>(InterpreterGGet))>>32));
       }
...
#line 2739 "src/interpreter/bytecode-interpreter.dasc"
    ...
    case BC_FSTART:
      //|=>bc:
      //|  instr_B
      dasm_put(Dst, 6338, bc);
#line 2750 "src/interpreter/bytecode-interpreter.dasc"
      ...
      //|  branch_to ARG2F,ARG3F
      //|  jmp <2
      dasm_put(Dst, 6347, Value::FLAG_FALSE);
#line 2758 "src/interpreter/bytecode-interpreter.dasc"
    ...
    case BC_FEND1:
      ...
      dasm_put(Dst, 6397, bc, Value::FLAG_REAL);
#line 2765 "src/interpreter/bytecode-interpreter.dasc"

      //|  cmp dword [STK+ARG2F*8+4], Value::FLAG_REAL
      //|  jnb ->InterpreterForEnd1
      dasm_put(Dst, 6416, Value::FLAG_REAL);
#line 2768 "src/interpreter/bytecode-interpreter.dasc"

      //|  movsd xmm0, qword [STK+ARG1F*8]
      //|  ucomisd xmm0, qword [STK+ARG2F*8]
      //|  jae >8 // loop exit
      dasm_put(Dst, 6428);
#line 2772 "src/interpreter/bytecode-interpreter.dasc"
...
#line 2781 "src/interpreter/bytecode-interpreter.dasc"
      ...
      dasm_put(Dst, 6489, RuntimeLayout::kCurPCOffset);
      ...
      dasm_put(Dst, 278, (unsigned int)(reinterpret_cast<std::uintptr_t>(InterpreterForEnd1)), (unsigned int)((reinterpret_cast<std::uintptr_t>(InterpreterForEnd1))>>32));
       }
#line 2789 "src/interpreter/bytecode-interpreter.dasc"
      ...
      //|  Dispatch
      dasm_put(Dst, 6517, RuntimeLayout::kCurPCOffset);
#line 2794 "src/interpreter/bytecode-interpreter.dasc"
    ...
    case BC_FEND2:
      ...
      //|  cmp dword [STK+ARG3F*8+4], Value::FLAG_REAL
      //|  jnb >6
      dasm_put(Dst, 6549, bc, Value::FLAG_REAL, Value::FLAG_REAL, Value::FLAG_REAL);
#line 2805 "src/interpreter/bytecode-interpreter.dasc"
...
#line 2820 "src/interpreter/bytecode-interpreter.dasc"
      ...
      dasm_put(Dst, 6632, RuntimeLayout::kCurPCOffset);
      ...
      dasm_put(Dst, 278, (unsigned int)(reinterpret_cast<std::uintptr_t>(InterpreterForEnd2)), (unsigned int)((reinterpret_cast<std::uintptr_t>(InterpreterForEnd2))>>32));
       }
#line 2829 "src/interpreter/bytecode-interpreter.dasc"
      //|  test eax,eax
      //|  je ->InterpFail
      //|  mov PC, qword [RUNTIME+RuntimeLayout::kCurPCOffset]
      //|  Dispatch
...
#line 2839 "src/interpreter/bytecode-interpreter.dasc"
    ...
    case BC_FEVREND:
      ...
      //|  branch_to ARG1F,ARG3F
      //|  Dispatch
      dasm_put(Dst, 5176, bc);
#line 2846 "src/interpreter/bytecode-interpreter.dasc"
      break;

    case BC_BRK:
      //|  absolute_jmp BC_BRK
      dasm_put(Dst, 5176, BC_BRK);
#line 2850 "src/interpreter/bytecode-interpreter.dasc"
      break;

    case BC_CONT:
      //|  absolute_jmp BC_CONT
      dasm_put(Dst, 5176, BC_CONT);
#line 2854 "src/interpreter/bytecode-interpreter.dasc"
      break;
...
#line 2860 "src/interpreter/bytecode-interpreter.dasc"
      ...
      dasm_put(Dst, 1165, RuntimeLayout::kCurPCOffset);
      ...
      dasm_put(Dst, 278, (unsigned int)(reinterpret_cast<std::uintptr_t>(InterpreterFEStart)), (unsigned int)((reinterpret_cast<std::uintptr_t>(InterpreterFEStart))>>32));
       }
...
#line 2875 "src/interpreter/bytecode-interpreter.dasc"
      ...
      dasm_put(Dst, 278, (unsigned int)(reinterpret_cast<std::uintptr_t>(InterpreterFEEnd)), (unsigned int)((reinterpret_cast<std::uintptr_t>(InterpreterFEEnd))>>32));
       }
...
#line 2885 "src/interpreter/bytecode-interpreter.dasc"
    ...
    case BC_IDREF:
      ...
      //|  instr_D
      dasm_put(Dst, 2325, bc);
#line 2890 "src/interpreter/bytecode-interpreter.dasc"
      ...
      dasm_put(Dst, 6696, RuntimeLayout::kCurPCOffset);
      ...
      dasm_put(Dst, 278, (unsigned int)(reinterpret_cast<std::uintptr_t>(InterpreterIDref)), (unsigned int)((reinterpret_cast<std::uintptr_t>(InterpreterIDref))>>32));
       }
#line 2897 "src/interpreter/bytecode-interpreter.dasc"
      //|  test eax,eax
      //|  je ->InterpFail
      //|  mov PC, qword [RUNTIME+RuntimeLayout::kCurPCOffset]
      //|  Dispatch
...
#line 2901 "src/interpreter/bytecode-interpreter.dasc"
    ...
    case BC_CALL:
      ...
      dasm_put(Dst, 6723, bc, RuntimeLayout::kStackEndOffset, Value::FLAG_HEAP, -HOH_TYPE_OFFSET, CLOSURE_BIT_PATTERN, ClosureLayout::kArgumentSizeOffset, RuntimeLayout::kCurClsOffset, ClosureLayout::kPrototypeOffset, ClosureLayout::kCodeBufferOffset);
      dasm_put(Dst, 6843, RuntimeLayout::kCurStackOffset);
       if(CheckAddress(reinterpret_cast<std::uintptr_t>(ResizeStack))) {
      dasm_put(Dst, 6892);
       } else {
         lava_warn("%s","Function ResizeStack address is not in 0-2GB");
      dasm_put(Dst, 278, (unsigned int)(reinterpret_cast<std::uintptr_t>(ResizeStack)), (unsigned int)((reinterpret_cast<std::uintptr_t>(ResizeStack))>>32));
       }
      dasm_put(Dst, 6897);
#line 3007 "src/interpreter/bytecode-interpreter.dasc"
      break;

    case BC_TCALL:
      //|=>bc:
      //|  do_call tcall_flag,InterpTCall
      dasm_put(Dst, 6918, bc, RuntimeLayout::kStackEndOffset, Value::FLAG_HEAP, -HOH_TYPE_OFFSET, CLOSURE_BIT_PATTERN, ClosureLayout::kArgumentSizeOffset, RuntimeLayout::kCurClsOffset, ClosureLayout::kPrototypeOffset, ClosureLayout::kCodeBufferOffset);
      dasm_put(Dst, 6843, RuntimeLayout::kCurStackOffset);
       if(CheckAddress(reinterpret_cast<std::uintptr_t>(ResizeStack))) {
      dasm_put(Dst, 6892);
       } else {
      ...
      dasm_put(Dst, 6897);
#line 3012 "src/interpreter/bytecode-interpreter.dasc"
      break;
    ...
    //|  Dispatch
    dasm_put(Dst, 7044, bc, IFRAME_EOF, RuntimeLayout::kCurClsOffset, ClosureLayout::kPrototypeOffset, ClosureLayout::kCodeBufferOffset, Value::FLAG_NULL);
#line 3050 "src/interpreter/bytecode-interpreter.dasc"
    break;
    ...
    //|  mov qword [ACC], RREG
    //|  Dispatch
    dasm_put(Dst, 7147, bc, IFRAME_EOF, RuntimeLayout::kCurClsOffset, ClosureLayout::kPrototypeOffset, ClosureLayout::kCodeBufferOffset);
#line 3059 "src/interpreter/bytecode-interpreter.dasc"
    break;

    default:
      //|=> bc:
      //|  Break
      dasm_put(Dst, 7252,  bc);
#line 3064 "src/interpreter/bytecode-interpreter.dasc"
      break;
  }
}
