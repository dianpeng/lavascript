...
/**
 * All lavascript heap object must be aligned with 8
 */
#define LAVASCRIPT_OBJECT_ALIGN alignas(8)
...
class LAVASCRIPT_OBJECT_ALIGN SSO final {
 public:
...
struct LAVASCRIPT_OBJECT_ALIGN LongString final {
...
class LAVASCRIPT_OBJECT_ALIGN String final : public HeapObject {
 public:
  inline const void* data() const;
...
class LAVASCRIPT_OBJECT_ALIGN List final : public HeapObject {
 public:
 ...
 */
class LAVASCRIPT_OBJECT_ALIGN Slice final : public HeapObject {
...
class LAVASCRIPT_OBJECT_ALIGN Object final : public HeapObject {
 public:
...
class LAVASCRIPT_OBJECT_ALIGN Map final : public HeapObject {
...
class LAVASCRIPT_OBJECT_ALIGN Iterator : public HeapObject {
 public:
...
class LAVASCRIPT_OBJECT_ALIGN Prototype final : public HeapObject {
 public:
...
class LAVASCRIPT_OBJECT_ALIGN Closure final : public HeapObject {
 public:
 ...
 */
class LAVASCRIPT_OBJECT_ALIGN Script final : public HeapObject {
 public:
